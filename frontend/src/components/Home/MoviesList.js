		...
		return this.title && this.newRating
			? this.setState({
				movies: this.state.movies.filter(
					(movie) => movie.vote_average >= this.newRating && movie.title.toLowerCase().includes(this.title)
				)
			})
			: this.title
				? this.setState({
				...
				: this.newRating
					? this.setState({
						movies: this.state.movies.filter((movie) => movie.vote_average >= this.newRating)
					})
					: this.setState({
